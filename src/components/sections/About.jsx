...
export const About = () => {
    ...
    const backendSkills = ["nodejs", "Express", "JSON", "MongoDB"]
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                    <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                        ...
                        <ul className="list-disc list-inside text-gray-300 space-y-2">
                            <li>
                                <strong>B.S in Computer Science</strong> - Maharaja Institute Of Technology Mysore
                            </li>
                        </ul>
                    </div>
                    <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                        ...
                        <div className="space-y-4 text-gray-300">
                            <div>
                                <h4 className="font-semibold">Embedded Engineer at DTRI (2023-2024)</h4>
                                <p>think and write</p>
                            </div>
                            <div>
